                ...
                <div className="row">
                    ...
                    <div className="col-12-xs">
                        <div className="card custom-hover-bg p-3">
                            ...
                            <div className="row custom-color-bg-hover pt-2">
                                <div className="col-1-xs"><p className="custom-sub-text">hahaha</p></div>
                                <div className="col-3-xs"><p className="custom-sub-text">hahaha</p></div>
                                <div className="col-2-xs"><p className="custom-sub-text">hahaha</p></div>
                                <div className="col-2-xs"><p className="custom-sub-text">hahaha</p></div>
                                <div className="col-2-xs"><p className="custom-sub-text">hahaha</p></div>
                                <div className="col-2-xs"><p className="custom-sub-text">hahaha</p></div>
                            </div>
