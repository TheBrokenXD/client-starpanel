const Terms = () => {
    return (
        <>
            ...
            <p className="custom-sub-text mt-1 pl-2">By registering you affirm that you are 18 years of age or an emancipated minor and are completely able and competent to enter into the terms and conditions set forth in these Terms of Service and comply and abide by them.</p>
            ...
            <p className="custom-sub-text mt-1 pl-2">If your Followers/Likes Order is Partialled and service is with Guarantee, we will not offer any Refills/Refunds in such cases as we partial because of your old drops especially counts like 500k , 1m , 2m etc ,</p>
            <p className="custom-sub-text mt-1 pl-2">If your order is dropped and you have placed new Order without refilling your old order. It will be your loss , we wont be able to help you in this case.</p>
            <p className="custom-sub-text mt-1 pl-2">If You are ordering any Refill service and in between you used any No refill service , your refill validity will be over for your old orders.</p>
        
            <p className="font-xl fw-md custom-text mt-3">Policies</p>
            ...
            <p className="custom-sub-text mt-1 pl-2">Please do not use more than one server at the same time for the same page or do not make any other order StarPanel on same link till previous one get marked completed. We cannot give you correct followers/likes number in that case. We will not refund for these orders.</p>

            <p className="custom-sub-text mt-2 pl-2">Paypal, Paytm, UPI, GooglePay Etc</p>
            ...
            <p className="font-lg fw-md custom-text mt-3">2. Privacy Policy</p>
            <p className="custom-sub-text mt-1 pl-2">This policy covers how we use your personal information. We take your privacy seriously and will take all measures to protect your personal information.</p>
            <p className="custom-sub-text mt-1 pl-2">Any personal information received will only be used to fill your order. We will not sell or redistribute your personal information to anyone. All personal information is encrypted and saved in secure servers.</p>
